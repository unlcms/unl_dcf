 ...
 * )
 */
class DcfBasePlugin extends CKEditor5PluginDefault implements CKEditor5PluginConfigurableInterface {
  ...
  public function settingsForm(array $form, FormStateInterface $form_state, Editor $editor) {
    ...
    $form['enabled_plugins'] = [
      ...
      '#description' => $this->t('DCF CKEditor5 plugins that should be enabled for this editor.'),
      '#element_validate' => [
